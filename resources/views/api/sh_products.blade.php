...
@section('javascript')
    ...
    function product(id){
        ...
        function showAimsProducts(id) {
            var input = $('#hidden');
            input.val(id);
            let columns = ['styleColorID', 'style', 'color'];
            let columnDefs = [
                {
                    render: (data, type, row) => {
                        return `<button class="btn"  onclick="match(${row.id})" style="color:black;">
                        <i class="fas fa-equals"></i></button>`
                    },
                    ...
                    render: (data, type, row) => {
                        if(row.status == '0')
                        {
                            return `<button class="btn" data-toggle="modal" data-target="#editProduct" onclick="product(${row.id})" style="background-color: transparent;">
                                ...
                                <button class="btn"  onclick="showAimsProducts(${row.id})" data-toggle="modal" data-target="#matchProducts">
                            <i class="fas fa-equals"></i></i></button>`;
                        }
                    },
        ...
        <div class="card col-12" style="border: none;border-radius:20px;margin-top: 5vh;">
            ...
            <div class="card-body">
                ...
                <div class="row justify-content-center my-4">
                    <div class="col">
                        <table class='table table-hover text-center my-1' id="shiphero_products" style="border-color: white;width:100% !important">
                            <thead>
                            <tr class="text-black">
        ...
        <div class="modal-dialog  modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-header" style=" border: none;">
                    <h4 class="modal-title" style="margin-left: 15vw;">Match Aims360 Products</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>

                <!-- Modal body -->
                <div class="modal-body mx-4" id="body">
                    <table class='table text-centered' id="modal_products" style="width: 100% !important;">
                        <thead>
                        <tr class='text-black'>
